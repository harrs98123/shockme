/**
 * Deep links into streaming apps, ported from `frontend/lib/utils.ts`.
 *
 * These are https URLs on purpose: `Linking.openURL` hands them to the
 * installed Netflix / Prime / Hotstar app when it claims the domain, and falls
 * back to the browser when it does not. Custom app schemes would fail outright
 * on devices without the app installed.
 */
