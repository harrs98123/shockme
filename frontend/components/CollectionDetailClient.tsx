          ...
          <div style={{ marginTop: 40, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: 40 }}>
            <div style={{ flex: 1, paddingRight: 60 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 24, marginBottom: 24, flexWrap: 'wrap' }}>
                <Link href={`/user/${collection.user_id}`} style={{ textDecoration: 'none' }} className="group">
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, color: 'rgba(255,255,255,0.7)', fontSize: 14, fontWeight: 600 }}>
                    <div style={{ width: 32, height: 32, borderRadius: '50%', background: 'linear-gradient(to tr, #8B5CF6, #EC4899)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, fontWeight: 'bold', color: 'white' }}>
                      👤
                    </div>
                    <span className="group-hover:text-white group-hover:underline">Curator: User #{collection.user_id}</span>
                  </div>
                </Link>
